    ...
    <div className="overflow-x-hidden" style={{ backgroundColor: "#faf5eb" }}>
      ...
      <section className="pt-32 pb-10 md:pt-40 md:pb-14 px-4 sm:px-6 lg:px-8 text-center">
        <div ref={heroRef}>
          ...
          >
            Contact <span className="" style={{ color: "#FFB936" }}>HP Studio</span>
          </h1>
...
>>>>>>> b5905f9 (Fresh clean commit)
          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FFB936" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
          ...
          >
            <h2
              ...
              style={{ fontFamily: "var(--font-family-playfair)", color: "#0d0d0d" }}
            >
              Send an <span className="" style={{ color: "#FFB936" }}>Enquiry</span>
            </h2>
            ...
            >
              ...
              >
                <div className="text-center">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#FFB936" strokeWidth="1.5" className="mx-auto mb-3">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                    <circle cx="12" cy="10" r="3" />
                  </svg>
...
>>>>>>> b5905f9 (Fresh clean commit)
            ...
            >
              ...
              >
                ...
                <span className="" style={{ color: "#FFB936" }}>Hours</span>
              </h3>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.day} className="flex items-center justify-between border-b pb-3" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
                    ...
                    <span className="text-sm font-medium" style={{ color: "#FFB936" }}>{item.time}</span>
                  </div>
                ))}
                <div className="flex items-center justify-between">
                  <span className="text-sm text-white/60">Outdoor Shoots</span>
                  <span className="text-sm font-medium" style={{ color: "#FFB936" }}>By Appointment</span>
                </div>
              </div>
