  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4 text-center flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
        <span className="text-xs md:text-sm font-bold tracking-[0.2em] uppercase" style={{ color: "#131313ff" }}>

        </span>
        <span className="hidden sm:inline text-[#0d0d0d]/40">|</span>
        <span className="text-sm md:text-base font-extrabold" style={{ fontFamily: "var(--font-family-playfair)", color: "#0d0d0d" }}>
          Get <strong className="font-black">10%</strong> Discount on Your First Shoot
        </span>
        <span className="hidden sm:inline text-[#0d0d0d]/40">|</span>
