      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="reveal parallax-text will-change-transform">
            ...
            >
              Meet <span className="" style={{ color: "#FFB936" }}>HP Studio</span>
            </h2>
  ...
  return (
    <div>
      <div
        ...
        style={{ fontFamily: "var(--font-family-playfair)", color: "#FFB936" }}
      >
        {count}{suffix}
      </div>
...
function StatsStrip() {
  ...
  return (
    <div ref={stripRef} style={{ backgroundColor: "#1f1f1f" }}>
