  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "#faf5eb" }}>
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-xs md:text-sm tracking-[0.3em] uppercase mb-3" style={{ color: "#FFB936" }}>
        ...
        >
          ...
          <span className="" style={{ color: "#FFB936" }}>Team</span>
        </h2>
          ...
          {team.map((member) => (
            <div key={member.name} className="team-card flex flex-col items-center">
              ...
              <h3
                ...
                style={{ fontFamily: "var(--font-family-playfair)", color: "#a12a2aff" }}
              >
                {member.name}
              </h3>
