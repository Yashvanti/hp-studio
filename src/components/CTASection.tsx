...
export default function CTASection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".cta-button", { opacity: 0, y: 20, duration: 0.6, stagger: 0.2, delay: 0.5 });
    }, sectionRef);
    return () => ctx.revert();
  }, []);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] items-center gap-8 lg:gap-6">
          ...
          <div ref={leftRef} className="hidden lg:flex justify-center lg:justify-end will-change-transform">
            <div className="relative">
              ...
              <div
                ...
                style={{ border: "1.5px solid #FFB936" }}
              />
              {/* Decorative dots */}
              <div
                className="absolute -top-6 -left-6 w-3 h-3 rounded-full"
                style={{ backgroundColor: "#FFB936", opacity: 0.3 }}
              />
              <div
                className="absolute -bottom-4 -right-4 w-2 h-2 rounded-full"
                style={{ backgroundColor: "#FFB936", opacity: 0.25 }}
              />
              {/* Sparkle */}
              <svg className="absolute -top-8 right-4 opacity-30" width="16" height="16" viewBox="0 0 16 16" fill="#FFB936">
          ...
          <div ref={centerRef} className="relative text-center max-w-lg mx-auto lg:mx-0 lg:px-4 will-change-transform">
            ...
            >
              ...
              <br />
              <span className="" style={{ color: "#FFB936" }}>
                last forever
              </span>
            </h2>
          ...
          <div ref={rightRef} className="hidden lg:flex justify-center lg:justify-start will-change-transform">
            <div className="relative">
              ...
              />
              {/* Sparkle */}
              <svg className="absolute -bottom-8 right-6 opacity-30" width="16" height="16" viewBox="0 0 16 16" fill="#FFB936">
                <path d="M8 0 L9.5 6.5 L16 8 L9.5 9.5 L8 16 L6.5 9.5 L0 8 L6.5 6.5 Z" />
              </svg>
